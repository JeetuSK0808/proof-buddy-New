...
class EquationalProofLine(models.Model):
    ...
    # Per-line comments (comment feature): instructor prompt, student reply,
    # and an instructor-set correctness flag (null = not yet reviewed).
    # Schema source: equational_reasoning_api/migrations/0006_add_comment_fields
    instructor_comment = models.TextField(blank=True, default='')
    student_comment = models.TextField(blank=True, default='')
    comment_correct = models.BooleanField(default=None, null=True)
